...
2026-08-05. **계획과 결정** 문서다 — 실제로 한 일과 그 길에 배운 것은
[055](20260805_055_image-normalization.md) 에 있다.
...
| 단계 | 상태 |
|---|---|
| 1. `export_review.py` | **끝** — 시야 432 · 교정 6,732 |
| 2. `Image` + 두 FK(nullable) | **끝** — `0019` · v0.5.4 (055) |
| 3. 백필 | **끝** — 이미지 1,952 · 검출 2,076 · 교정 6,738 (055) |
| 4. 파이프라인이 `image` 를 쓴다 | **끝** — `0020`·`0021` · v0.5.5 · v0.2.1 (055) |
| 5a. 조이기 | **끝** — `0022` · v0.5.6 · v0.2.2 (055) |
| 5b. 프레임별 검토 | 남음 — 결정은 §8 |

## 7. 5단계에서 내보내기 형식도 함께 올린다 (format 2 → 3)
...
## 8. 5단계를 둘로 갈랐다 (사용자 결정 2026-08-05)
